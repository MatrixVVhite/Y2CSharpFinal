...
namespace Commands
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Player p2 = new Player(0, ConsoleColor.Green, 1, -1);
            ...
            TileObject to2 = new TileObject("P", new Position[] { new Position(0, 0), new Position(0, 0) }, new Position(2, 5), p2);
            ...
            List<TileObject> p1List = new List<TileObject>() { to1 };
            p1.AddPieces(p1List);
